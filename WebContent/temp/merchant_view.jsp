...
<tr><th colspan="2" class="">View Merchant Details</th></tr>
<tr><td>User ID:</td><td class="data">10</tr>
<tr><td>Role:</td><td  class="data"> Merchant </td></tr>
<tr><td>Employee ID:</td><td  class="data"></td></tr>
<tr><td>First Name:</td><td  class="data">Nicholas</td></tr>
<tr><td>Last Name:</td><td  class="data">Cage</td></tr>
<tr><td>Gender:</td><td  class="data">M</td></tr>
<tr><td>Mobile:</td><td  class="data">99807865</td></tr>
<tr><td>Email ID:</td><td  class="data">nicholas@google.com</td></tr>
<tr><td>Create Date:</td><td  class="data">26/08/2011</td></tr>
<tr><td>Last Update Date:</td><td  class="data">12/08/2011</td></tr>

<tr><td>Merchant ID:</td><td  class="data">10</td></tr>
<tr><td>Merchant Type:</td><td  class="data">POS</td></tr>
<tr><td>Location:</td><td  class="data">Suntec City</td></tr>
<tr><td>Status:</td><td  class="data">Active</td></tr>

</table>
<input type="hidden" value="" name="isfirstlogin" id="isfirstlogin" />

<button type="button">Save</button> 
<button type="button">Add Terminal</button> 
<button type="button">Add Deals</button> 
 
</form>
 <p>&nbsp;</p>
<table width="100%" class="listtable">
 <tr>
 <th colspan="2" class="">Terminal</th> </tr>
 <tr><td>Terminal ID:</td><td class="data">239909</td></tr>
</table>
<p>&nbsp;</p>
<table width="100%" class="listtable">
 <tr>
